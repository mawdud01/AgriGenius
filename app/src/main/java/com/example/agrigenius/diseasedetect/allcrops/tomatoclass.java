...
public class tomatoclass extends AppCompatActivity {

    TextView result, confidence,confidencetext,prevent;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tomatoclass);
...
// find the index of the class with the biggest confidence above 80%.
            ...
            String[] classes = getResources().getStringArray(R.array.tomatodisease);
    ...
    public void onBackPressed() {
        //super.onBackPressed();
        Intent intent = new Intent(tomatoclass.this, diseasedetection.class);
